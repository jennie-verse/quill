/* ==========================================================================
   ...
   (WebApp_House_Style.md 8장 / 프로젝트 지시문)
   ========================================================================== */
...
const VERSION = '2026.09.12-textsize1';
...
self.addEventListener('install', (event) => {
  event.waitUntil((async () => {
    ...
    // { cache: 'reload' } 로 브라우저 HTTP 캐시를 건너뜁니다 — 이게 없으면
    // 방금 방문해서 HTTP 캐시에 남아있는 옛 파일이 새 버전 캐시에 그대로
    // 복사되어, VERSION 을 올려도 실제로는 업데이트가 안 될 수 있습니다.
